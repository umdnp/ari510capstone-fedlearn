#!/usr/bin/env python3
"""
Local test for the scoring program.
"""
...
def main():
    ...
    input_dir = Path('/tmp/codabench_test/input')
    output_dir = Path('/tmp/codabench_test/output')
    ...
    print(f"\nTest passed! Scoring script works correctly.")
